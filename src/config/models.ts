export const MODELS = {
    ...
    BRAIN_2: process.env.AGENT_BRAIN_2 || 'qwen/qwen3-32b',
    BRAIN_3: process.env.AGENT_BRAIN_3 || 'gemini-3.1-flash-lite',
    TOOL: process.env.AGENT_TOOL_MODEL || 'meta-llama/llama-4-scout-17b-16e-instruct',
